...
import type { MultipleChoiceGridFormField } from "@/lib/formConfig";

interface MultipleChoiceGridProps {
  field: MultipleChoiceGridFormField;
  value: Record<string, string>;
  onChange: (value: Record<string, string>) => void;
  error?: string;
}

export default function MultipleChoiceGrid({ field, value, onChange, error }: MultipleChoiceGridProps) {
